% Script to test The Vibrato Monte Carlo Method
STRIKEPRICE = [];
DELTA = [];
VEGA = [];
RHO = [];
...
for p = 1:0.5:20
    ...
    %hold on
    subplot(3,2,[1,2])
    plot(STRIKEPRICE,PRICE,'k')
    grid
    xlabel('Underlying')
    ylabel('Value')
    title('Price')
    subplot(3,2,3)
    plot(STRIKEPRICE,DELTA,'k')
    grid
    xlabel('Underlying')
    ylabel('Value')
    title('Delta')
    subplot(3,2,4)
    plot(STRIKEPRICE,VEGA,'k')
    grid
    xlabel('Underlying')
    ylabel('Value')
    title('Vega')
    subplot(3,2,5)
    plot(STRIKEPRICE,RHO,'k')
    grid
    xlabel('Underlying')
    ylabel('Value')
    title('Rho')
    subplot(3,2,6)
    plot(STRIKEPRICE,THETA,'k')
